...
- The production cube is tiered. Use the delta cube only for normal daily appends or small gap fixes. For large historical backfills (months/years), rebuild or compact the base cube from the daily store with the bulk builder, then reset delta to post-cutoff days. Do not leave large backfills permanently in delta.
