...
- [ ] P2-S5 hybrid router(point/range→cube,bbox/single-day+POST/points→daily)/ P2-S6 dual-write ingest(append-at-scale bench)/ P2-S7 local gate / P2-S8 VM24 binding(需 ≥365 contiguous real + cold)
