...
- [ ] **P2-S3+ Tier-2 time-cube**(cut chunk_count→O(days/time_chunk)+ 小空間 chunk + v3 sharding)/ P2-S4 access / P2-S5 hybrid routing / P2-S6 dual-write ingest / P2-S7 local gate / P2-S8 VM24
