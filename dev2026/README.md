...
- [ ] P2-S4 time_store access(per-day var absence on real data)/ P2-S5 hybrid router / P2-S6 dual-write ingest / P2-S7 local gate / P2-S8 VM24 binding(需 ≥365 contiguous real + cold)
